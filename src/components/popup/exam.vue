  ...
  <div class="modal" @click="modalShow">
    <div class="modal-main" @click.stop>
        <div class="modal-header">
          <i @click.stop="modalShow" class="icon-close" style="cursor: pointer;">
        ...
        <div class="modal-body">
          <div class="personal_info">
            <p class="modal-title">Imtihon topshirish manzili va vaqtini kiriting</p>
            <div class="row-12">
              <div class="fcol">
