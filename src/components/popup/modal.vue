      ...
      <div class="modal-main" @click.stop>
          ...
          <div class="modal-body">
            ...
            <div class="prof-status">
              <p>Profil holati</p>
              <div class="prof-status-toggle">
                <p class="deactive">Faol emas</p>
                <div class="toggle">
                    <label class="switch">
                      <input type="checkbox" @click="changestatus" v-model="status">
                      <span class="slider round"></span>
                    </label>
                </div>
                <p class="active">Faol</p>
              </div>
            </div>
...
export default {
  ...
  methods: {
    save(){
      return this.$axios({
      method: "PUT",
      url: "users/"+this.user_info?.user_id,
      data: {...this.userRole}
      }).then((res) => {
      return res
      }).catch((err) => {
