      ...
      <div class="guide-add-wrapper">
        <div class="guide-add">
          <div class="guide-inp">
            ...
            <input
              :class="{
                required:
                  $v.guide.first_name.$dirty && !$v.guide.first_name.required,
              }"
              v-model="guide.first_name"
          ...
          <div class="guide-inp">
            ...
            <input
              :class="{
                required:
                  $v.guide.last_name.$dirty && !$v.guide.last_name.required,
              }"
              v-model="guide.last_name"
              class="el-input__inner"
              type="text"
          ...
          <div class="guide-inp">
            ...
            <input
              v-model="guide.middle_name"
              class="el-input__inner"
              type="text"
              :placeholder="$t('placeholder_midname')"
            />
          </div>
          <div class="guide-inp">
            <label for="">{{ $t('territory') }}</label>
            <el-select
              v-model="guide.regions"
              multiple
              collapse-tags
              clearable
              filterable
          ...
          <div class="guide-inp">
            ...
            <el-date-picker
              ...
              :class="{
                required:
                  $v.guide.birth_date.$dirty && !$v.guide.birth_date.required,
              }"
              format="dd.MM.yyyy"
          ...
          <div class="guide-inp">
            ...
            <el-select
              :class="{
                required:
                  $v.guide.guide_type.$dirty && !$v.guide.guide_type.required,
              }"
              v-model="guide.guide_type"
              clearable
              filterable
              :placeholder="$t('placeholder_guide_type')"
            >
              <el-option
                v-for="item in gtype"
                :key="item.id"
          ...
          <div class="guide-inp">
            ...
            <el-select
              :class="{
                required:
                  $v.guide.category.$dirty && !$v.guide.category.required,
              }"
              v-model="guide.category"
              clearable
              filterable
              :placeholder="$t('placeholder_guide_category')"
            >
              <el-option
          ...
          <div class="guide-inp">
            ...
            <input
              :class="{
                required:
                  $v.guide.personal_phone_number.$dirty &&
                  !$v.guide.personal_phone_number.required,
              }"
              v-model="guide.personal_phone_number"
              class="el-input__inner"
              type="text"
              :placeholder="$t('placeholder_work_phone')"
            />
          </div>
          <div class="guide-inp">
            <label for="">{{ $t('work_phone') }}</label>
            <input
              v-model="guide.work_phone_number"
              class="el-input__inner"
              type="text"
              :placeholder="$t('placeholder_work_phone')"
            />
            ...
            <div class="guide-file">
              ...
              <div v-else class="guide-file-uploaded">
                ...
                <div @click="clearImage" class="icons">
                  <Icons icon="closeFilled" size="middle" />
                </div>
              </div>
              <div class="guide-file-info">
                ...
                <label
                  :class="{
                    required: $v.guide.logo.$dirty && !$v.guide.logo.required,
                  }"
                  for="imageguide"
                  class="button"
                  >{{ $t('uploadImg') }}</label
          ...
          <div class="guide-inp">
            <div class="guide-file">
              ...
              <div class="guide-file-info">
                ...
                <label for="fileDiploma" class="button">{{
                  $t('uploadFile')
                }}</label>
              </div>
            </div>
        ...
        <div class="guide-add">
          ...
          <div class="guide-inp">
            ...
            <input
              v-model="guide.univer_name"
              class="el-input__inner"
              type="text"
              :placeholder="$t('placeholder_nameuniver')"
            />
          </div>
          <div class="guide-inp">
            <label for="">{{ $t('special') }}</label>
            <input
              v-model="guide.univer_profession"
              class="el-input__inner"
              type="text"
              :placeholder="$t('placeholder_special')"
            />
          </div>
        </div>
        <div class="guide-add-auto">
          <div class="guide-inp">
            ...
            <input
              class="el-input__inner"
              v-model="guide.univer_major"
              type="text"
              :placeholder="$t('placeholder_major')"
            />
          </div>
        </div>
        <div class="guide-add">
          <div class="guide-inp">
            ...
            <input
              v-model="guide.reg_num"
              class="el-input__inner"
              type="text"
              :placeholder="$t('placeholder_certNumber')"
            />
          </div>
          <div class="guide-inp">
        ...
        <div class="guide-save">
          <button @click="$router.go(-1)" class="cancel">
            {{ $t('cancel') }}
          </button>
...
export default {
  ...
  async mounted() {
    ;(this.main_crumb = [
      ...
      {
        title: this.title2[this.$i18n.locale],
        path: '/' + this.$i18n.locale + '/gids/add',
      },
    ]),
      await this.getmenu()
  },
